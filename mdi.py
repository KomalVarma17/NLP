...
for term in terms:
    ...
    if link:
        ...
        term_link = link['href']
        print(f"Term: {term_name}, Link: {term_link}")
...
for term in terms:
    ...
    if link:
        ...
        texts.extend(li.get_text(strip=True) for li in list_items)
...
ul_index = soup.find('ul', id='index')
terms = ul_index.find_all('li')
desired_headers = ['Symptoms', 'Treatment', 'Causes', 'Prevention', 'How the test is performed']
        ...
        for section in sections:
            ...
            if header_div:
                ...
                if header_title and header_title.get_text(strip=True) in desired_headers:
                    found_desired_header = True
                    print(f"Term: {term_name}\nLink: {term_link}\nSection Title: {header_title.get_text(strip=True)}")
...
desired_headers = ['Symptoms', 'Treatment', 'Causes', 'Prevention','Possible Complications', 'Exams and Tests', 'How the test is performed', 'How to Prepare for the Test', 'Whys the Test is Performed', 'Risks', 'Altenative Names', 'Normal Results']
